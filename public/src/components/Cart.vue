...
.price_count>.price,.price_count>.postage{
  margin:0.8rem 0;
  color:#3b3e40;
}
.price_count>.price>p,.price_count>.postage>p{
  float: right;
}
.button>button{
  width: 100%;
...
.select li>.product_nt,.select li>.product_price{
  text-align: center;
  line-height: 16px;
  height: 18px;
  max-height: 48px;
