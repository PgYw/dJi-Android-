    ...
    <div class="detail">
      ...
      <div class="account">
        ...
        <div class="joinC">
          ...
          <button @click="addCart($event)" :class="isExist?'addCart buttonActive':'addCart'" :disabled="isExist?true:false">加入购物车</button>
      ...
      <div class="product_xinxi">
        ...
        <div class="xinxi_title">
          ...
          <div class="product_synopsis">
            DJI 大疆迄今为止最小的三轴机械增稳云台相机。
  ...
  created() {
    ...
    if (this.$route.query.productId) {
      ...
      this.$axios
        ...
        .then(
          this.$axios.spread((product, productImg) => {
      ...
      if (sessionStorage.getItem("userId") != (undefined || null)) {
        ...
        if (this.product_arr.length > 0) {
          for (var i = 0; i < this.product_arr.length; i++) {
            if (
              this.product_arr[i].product_id == this.$route.query.productId ||
              this.product_arr[i].product_id == this.$route.query.relevancyId
            ) {
...
.joinC > button:active {
  background: linear-gradient(0deg, #1897f2, #42b7ff);
}
.joinC p {
  margin: 5px 0;
}
